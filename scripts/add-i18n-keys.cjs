...
const newKeys = {
  ...
  'help.screens.queue.pipelineSummaryDesc':
    'Clique nos badges de contagem (Queued, Processing, Done, Quarantined) para expandir um painel inline com a lista de ficheiros.',
  'help.screens.queue.reprocessPopupTitle': 'Popup de Reprocessamento (v0.23.0)',
  'help.screens.queue.reprocessPopupDesc':
    'Popup renderizado via portal para o foreground, escapando o overflow do container da tabela.',
  'help.screens.library.deleteConfirmTitle': 'Confirmação de Delete (v0.23.0)',
  'help.screens.library.deleteConfirmDesc':
    'Diálogo de confirmação em dois passos. Primeiro confirma a remoção do asset; segundo pergunta se quer apagar o ficheiro processado do disco.',
  'help.screens.settings.factoryResetConfirmTitle': 'Factory Reset com Confirmação (v0.23.0)',
  'help.screens.settings.factoryResetConfirmDesc':
    'Factory reset com autorização explícita para apagar ficheiros. Primeiro diálogo confirma o reset; segundo pergunta se apaga os ficheiros de output.',
