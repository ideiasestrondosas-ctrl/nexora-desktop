          ...
          {dropdownOpen && (
            <>
              ...
              <div className="absolute top-full left-0 right-0 mt-2 bg-bg-secondary border border-border rounded-xl shadow-2xl z-40 max-h-72 overflow-y-auto">
                {/* Sistema */}
                <div className="px-3 py-2 text-[10px] font-black uppercase tracking-widest text-text-muted">Pré-definidos</div>
                ...
                {profiles.some(p => !p.is_system) && (
                  <>
                    <div className="px-3 py-2 text-[10px] font-black uppercase tracking-widest text-text-muted border-t border-border">Personalizados</div>
                    {profiles.filter(p => !p.is_system).map(p => (
                      <button
                        key={p.id}
                        onClick={() => { setSelectedProfileId(p.id); setDropdownOpen(false); }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-bg-secondary border border-border rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xs font-black uppercase tracking-widest text-text-muted">Vídeo</h3>
              </div>
            ...
            <div className="bg-bg-secondary border border-border rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xs font-black uppercase tracking-widest text-text-muted">Áudio</h3>
              </div>
              <div className="space-y-3">
            ...
            <div className="bg-bg-secondary border border-border rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xs font-black uppercase tracking-widest text-text-muted">Qualidade</h3>
              </div>
              <div className="space-y-3">
          ...
          <div className="fixed right-0 top-0 bottom-0 w-[420px] bg-bg-secondary border-l border-border z-50 flex flex-col shadow-2xl animate-in slide-in-from-right">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-text-secondary uppercase tracking-wider border-b border-border pb-2">Geral</h3>
                <div>
                ...
                <div>
                  <label className="block text-xs font-medium text-text-secondary mb-1">Container</label>
                  <select
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-text-secondary uppercase tracking-wider border-b border-border pb-2">Vídeo</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-medium text-text-secondary mb-1">Codec</label>
                    <select
                  ...
                  <div>
                    <label className="block text-xs font-medium text-text-secondary mb-1">Resolução</label>
                    <select
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-medium text-text-secondary mb-1">Bitrate Vídeo (kbps)</label>
                    <input
                      type="number"
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-text-secondary uppercase tracking-wider border-b border-border pb-2">Áudio e Qualidade</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-medium text-text-secondary mb-1">Codec Áudio</label>
                    <select
                  ...
                  <div>
                    <label className="block text-xs font-medium text-text-secondary mb-1">Bitrate Áudio (kbps)</label>
                    <input
                      type="number"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-medium text-text-secondary mb-1">LUFS Alvo</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="block text-xs font-medium text-text-secondary mb-1">VMAF Mínimo</label>
                    <input
                      type="number"
