...
const SCREEN_TABS: { id: ScreenTab; labelKey: string; icon: React.ReactNode }[] = [
  ...
  { id: 'dashboard', labelKey: 'help.tabs.dashboard', icon: <LayoutDashboard className="w-4 h-4" /> },
          ...
          {activeTab === 'intro' && (
            <div className="space-y-5">
              <div className="bg-bg-secondary/80 backdrop-blur-sm rounded-xl border border-border/50 p-5">
                <h3 className="text-sm font-bold text-text-primary mb-2">{t('help.intro.whatIs')}</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <ScreenCard title={t('help.intro.features.vmafAnalysis')} icon={<HelpCircle className="w-4 h-4" />}>
                  {t('help.intro.features.vmafDesc')}
                </ScreenCard>
                <ScreenCard title={t('help.intro.features.profiles')} icon={<UserCircle className="w-4 h-4" />}>
                  {t('help.intro.features.profilesDesc')}
                </ScreenCard>
                <ScreenCard title={t('help.intro.features.gpuAuto')} icon={<Settings className="w-4 h-4" />}>
